...
- Pointer p1 travels: List A → List B

- Pointer p2 travels: List B → List A

- Both travel same total length

- If there is an intersection → they meet there

- If no intersection → both become null at same time
